...
var conteudoA = `<img src='imagens/b.jpg' /> <h2>Inicio</h2> <p>Um robo abandonado no meio do deserto chamado ${nomePerso} está em apuros. ${nomePerso} acordou no meio do deserto com pouca bateria, não se lembrava como foi parar ali, então levantou rapidamente e foi em direção ao sol, até chegar em uma cidade abandonada, e aproveitou para arrumar o seu braço com algumas sucatas que havia no local.</p> <br><br> <button onclick='carregarConteudo(conteudoB1)'>Ir para a continuação 1</button> <button onclick='carregarConteudo(conteudoB2)'>Ir para a continuação 2</button>`;
...
Chegando perto avistaram Lex, parado em um circulo, flutuando em cima da cidade.</p><br><br>

<button onclick='carregarConteudo(conteudoC1)'>Final 1</button> <button onclick='carregarConteudo(conteudoC2)'>Final 1.1</button>`;
...
- Nunca confie em estranhos. Adeus! Disse Rox.</p> <br><br>
...
Rox consertou ${nomePerso} e se preparam para uma próxima visita de um robo estranho que quer dominar tudo!</p> <br><br>
...
- Ele é exatamente isso, um guardião dos robos.</p> <br><br>

<button onclick='carregarConteudo(conteudoC3)'>Final 2</button> <button onclick='carregarConteudo(conteudoC4)'>Final 2.1</button>`;
...
Ele virou um tipo de mascote da cidade, que procura ajudar a todos!</p><br><br>
...
Ele ficou completamente descarregado e está escondido até os dias de hoje!</p><br><br>
